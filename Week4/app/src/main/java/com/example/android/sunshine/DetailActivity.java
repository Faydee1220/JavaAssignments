...
//      TODO (7) Display the weather icon using mDetailBinding
        ...
        mDetailBinding.primaryInfo.iconImageView.setImageResource(weatherImageId);
...
//        mDateView.setText(dateText);
        mDetailBinding.primaryInfo.dateTextView.setText(dateText);
...
//        mDescriptionView.setText(description);
        mDetailBinding.primaryInfo.descriptionTextView.setText(description);
        mDetailBinding.primaryInfo.descriptionTextView.setContentDescription(descriptionA11y);

//      TODO (16) Set the content description of the icon to the same as the weather description a11y text
        mDetailBinding.primaryInfo.iconImageView.setContentDescription(descriptionA11y);
...
//        mHighTemperatureView.setText(highString);
        mDetailBinding.primaryInfo.highTemperatureTextView.setText(highString);
        mDetailBinding.primaryInfo.highTemperatureTextView.setContentDescription(highA11y);
...
//        mLowTemperatureView.setText(lowString);
        mDetailBinding.primaryInfo.lowTemperatureTextView.setText(lowString);
        mDetailBinding.primaryInfo.lowTemperatureTextView.setContentDescription(lowA11y);
...
//        mHumidityView.setText(humidityString);
        mDetailBinding.extraDetails.humidityValueTextView.setText(humidityString);
        mDetailBinding.extraDetails.humidityValueTextView.setContentDescription(humidityA11y);

//      TODO (19) Set the content description of the humidity label to the humidity a11y String
        mDetailBinding.extraDetails.humidityTitleTextView.setContentDescription(humidityA11y);
...
//        mWindView.setText(windString);
        mDetailBinding.extraDetails.windValueTextView.setText(windString);
        mDetailBinding.extraDetails.windValueTextView.setContentDescription(windA11y);

//      TODO (22) Set the content description of the wind label to the wind a11y String
        mDetailBinding.extraDetails.windTitleTextView.setContentDescription(windA11y);
...
//        mPressureView.setText(pressureString);
        mDetailBinding.extraDetails.pressureValueTextView.setText(pressureString);
        mDetailBinding.extraDetails.pressureValueTextView.setContentDescription(pressureA11y);

//      TODO (24) Set the content description of the pressure label to the pressure a11y String
        mDetailBinding.extraDetails.pressureTitleTextView.setContentDescription(pressureA11y);
